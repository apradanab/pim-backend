...
describe('ServicesSqlRepo', () => {
  ...
  describe('readAll', () => {
    it('should call prisma.service.findMany and return services', async () => {
  ...
  describe('readById', () => {
    it('should return a service when the ID is valid', async () => {
    ...
    it('should throw a 404 error if the service is not found', async () => {
  ...
  describe('delete', () => {
    it('should delete a service with a valid ID', async () => {
